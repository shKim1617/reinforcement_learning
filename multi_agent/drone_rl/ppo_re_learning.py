...
# 모델 불러와서 이어서 학습
loaded_model_name = "drone_rl/model31_.zip"
loaded_model = PPO.load(
    loaded_model_name, 
    env=env, 
    device=device)

loaded_model.learn(total_timesteps=10000, callback=callback_list)

save_model_name = "drone_rl/model32_"
